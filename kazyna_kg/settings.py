"""
Django settings for kazyna_kg project.
...
SECRET_KEY = '$5rnju4%xpa+j461_#3@bbk26yp^(q(42a8#zyy4uxoo1*pg)^'
...
WSGI_APPLICATION = 'kazyna_kg.wsgi.application'
